...
const complaints: Complaint[] = [
  { id: 1, label: "Blurry Vision / Eye Floaters" },
  { id: 2, label: "Eye Pain / Redness / Discharge" },
  { id: 3, label: "Cataract Screening" },
  { id: 4, label: "Post-Eye Surgery Follow-up" },
];

export default function CcOphthalmology() {
  const [selected, setSelected] = useState<number | null>(null);

  const handleProceed = (): void => {
    const chosen = complaints.find((c) => c.id === selected);
    console.log("Ophthalmology complaint selected:", chosen?.label);
  };
    ...
    <div className="">
      ...
      <div className="min-h-screen flex flex-col gap-6 items-center justify-center bg-cyan-950 py-12">
        ...
        <div className="flex flex-col text-center">
          ...
          <h1 className="text-5xl font-bold text-white">Ophthalmology</h1>
          <p className="text-xl font-serif text-white mt-1">For eye and vision concerns</p>
        </div>
        ...
        <div className="flex flex-row gap-5 bg-cyan-900 px-10 py-8 rounded-xl w-[70rem]">
          ...
          <div className="flex flex-col flex-1 gap-4">
            ...
            <div className="pt-2 border-t border-dashed border-cyan-700">
              <button
                type="button"
                onClick={() => console.log("Not listed – Ophthalmology")}
          ...
          <div className="flex flex-col gap-4 w-64 flex-shrink-0">
            ...
            <div className="flex flex-col gap-2">
              ...
              <button
                type="button"
                onClick={() => console.log("Back – Ophthalmology")}
