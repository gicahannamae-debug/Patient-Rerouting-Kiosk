...
export default function SummaryNewPatient({
  patientName,
  age,
  gender,
  bpSys,
    ...
    <div className="flex flex-col gap-[1rem] flex-1">
      <div className="flex flex-col gap-[0.4rem]">
        ...
        <div className="bg-cyan-950 rounded-lg px-[1rem] py-[0.75rem]">
          <p className="text-[0.95rem] font-semibold text-white">New Patient</p>
          <p className="text-[0.88rem] text-cyan-400 mt-[0.25rem]">
            Patient is new to the facility and requires registration and triage.
          </p>
        </div>
      </div>
