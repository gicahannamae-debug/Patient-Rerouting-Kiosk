...
const complaints: Complaint[] = [
  { id: 1, label: "Wounds / Abscess / Lumps / Mass" },
  { id: 2, label: "Hernia / Hemorrhoids / Fistula" },
  { id: 3, label: "Acute Abdominal Pain" },
  { id: 4, label: "Post-Operative Follow-up" },
];

export default function CcSurgery() {
  const [selected, setSelected] = useState<number | null>(null);

  const handleProceed = (): void => {
    const chosen = complaints.find((c) => c.id === selected);
    console.log("Surgery complaint selected:", chosen?.label);
  };
    ...
    <div className="">
      ...
      <div className="min-h-screen flex flex-col gap-6 items-center justify-center bg-cyan-950 py-12">
        ...
        <div className="flex flex-col text-center">
          ...
          <h1 className="text-5xl font-bold text-white">Surgery</h1>
          <p className="text-xl font-serif text-white mt-1">Select the option that best describes your concern.</p>
        </div>
        ...
        <div className="flex flex-row gap-5 bg-cyan-900 px-10 py-8 rounded-xl w-[70rem]">
          ...
          <div className="flex flex-col flex-1 gap-4">
            ...
            <div className="pt-2 border-t border-dashed border-cyan-700">
              <button type="button" onClick={() => console.log("Not listed – Surgery")} className="text-sm text-orange-200 hover:text-white hover:underline cursor-pointer">
          ...
          <div className="flex flex-col gap-4 w-64 flex-shrink-0">
            ...
            <div className="flex flex-col gap-2">
              <button type="button" disabled={selected === null} onClick={handleProceed}
              ...
              <button type="button" onClick={() => console.log("Back – Surgery")}
