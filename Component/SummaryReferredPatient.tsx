...
export default function SummaryReferredPatient({
  patientName,
  age,
  gender,
  bpSys,
    ...
    <div className="flex flex-col gap-[1rem] flex-1">
      <div className="flex flex-col gap-[0.4rem]">
        ...
        <div className="bg-cyan-950 rounded-lg px-[1rem] py-[0.75rem]">
          <p className="text-[0.95rem] font-semibold text-white">Referred Patient</p>
          <p className="text-[0.88rem] text-cyan-400 mt-[0.25rem]">
            Patient was referred from another facility and has referral details attached.
          </p>
        </div>
      </div>

      <div className="flex flex-col gap-[0.4rem]">
        <p className="text-[0.78rem] font-semibold text-white uppercase tracking-wider">Referral Details</p>
        <div className="bg-cyan-950 rounded-lg px-[1rem] py-[0.75rem]">
          <div className="grid grid-cols-2 gap-[0.5rem]">
            <div>
              <p className="text-[0.72rem] text-orange-200 uppercase tracking-wider">Referred From</p>
              <p className="text-[0.95rem] font-semibold text-white">{referralFrom}</p>
            </div>
            <div>
              <p className="text-[0.72rem] text-orange-200 uppercase tracking-wider">Referring Doctor</p>
              <p className="text-[0.95rem] font-semibold text-white">{referralDoctor}</p>
            </div>
            <div>
              <p className="text-[0.72rem] text-orange-200 uppercase tracking-wider">Referral Date</p>
              <p className="text-[0.95rem] font-semibold text-white">{referralDate}</p>
            </div>
            <div>
              <p className="text-[0.72rem] text-orange-200 uppercase tracking-wider">Referral Form No.</p>
              <p className="text-[0.95rem] font-semibold text-white">{referralFormNo}</p>
            </div>
            <div className="col-span-2">
              <p className="text-[0.72rem] text-orange-200 uppercase tracking-wider">Diagnosis / Chief Complaint</p>
              <p className="text-[0.95rem] font-semibold text-white">{referralDiagnosis}</p>
            </div>
            <div className="col-span-2">
              <p className="text-[0.72rem] text-orange-200 uppercase tracking-wider">Purpose of Referral</p>
              <p className="text-[0.95rem] font-semibold text-white">{referralPurpose}</p>
            </div>
          </div>
        </div>
      </div>
