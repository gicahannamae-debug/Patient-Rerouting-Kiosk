...
{/* ── NAV ── */}
    ...
    <div className="flex flex-col gap-[9px] flex-1 items-center  justify-center bg-cyan-950 font-sans w-full-absolute h-screen">
      ...
      <button onClick={onStart} className=" text-[1.875rem] font-semibold hover:cursor-pointer bg-orange-50 hover:bg-orange-100 text-cyan-950 px-[1.875rem] py-[.5rem] rounded-md">Start Self Service Triage </button>
    </div>
    </div> 
  ); 
}